...
{{--            <p class="text-gray-700">Mostrar perfil: {{ $user->profile->display_profile ?? "No" }}</p>--}}
        </div>
...
{{--            <p class="text-gray-700">Suscrito a la Newsletter: {{ $user->notification->receive_newsletter ?? "Sí"  }}</p>--}}
{{--            <p class="text-gray-700">Recibir promociones: {{ $user->notification->receive_promotions ?? "Sí"  }}</p>--}}
{{--        </div>--}}
